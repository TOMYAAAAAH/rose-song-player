...
export default function SongList() {
    ...
    const sortedTracks = [...tracks].sort((a, b) => {
        ...
        let compareValue;
        if (sortBy.includes('popularity')) { //pick sort category
    ...
    return (
        <>
            <div className="flex justify-between items-center mb-5">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        <div
                            className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-pink-900">
            ...
            <div className="grid grid-cols-4 gap-5">
                {sortedTracks
                    .filter((track) => !search || track.title.toLowerCase().includes(search.toLowerCase()))
                    .map((track) => {
                    const relatedAlbum = albums.find((album) => album.name === track.album);
                    return (
                        <Song
                            key={track.title}
